...
public class CmdExecutorFactory implements SmartInitializingSingleton, BeanFactoryPostProcessor {
    ...
    // value: CmdExecutor
    private final Map<Class<?>, CmdExecutor<?>> cmdExecutorHolder = new HashMap<>();
    ...
    public <C> CmdExecutor<C> get(Class<C> cmdClazz, Class<?> aggregateRootClazz) {
